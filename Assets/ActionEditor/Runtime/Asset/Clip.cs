...
namespace PKC.ActionEditor
{
    public class Clip : IClip
    {
        ...
        {
            if (this is ISubClipContainable subClip && Mathf.Abs(subClip.SubClipSpeed) > Mathf.Epsilon)
                Length = subClip.SubClipLength / subClip.SubClipSpeed;
        }
    ...
    public abstract class ClipCrossBlend : Clip
    {
        ...
        public override float BlendIn
        {
            ...
            set
            {
                ...
                else if (blendIn > Mathf.Max(0, Length - BlendOut))
                {
                    blendIn = Mathf.Max(0, Length - BlendOut);
                }
            }
        }
        ...
        public override float BlendOut
        {
            ...
            set
            {
                ...
                else if (blendOut > Mathf.Max(0, Length - BlendIn))
                {
                    blendOut = Mathf.Max(0, Length - BlendIn);
                }
            }
        }
