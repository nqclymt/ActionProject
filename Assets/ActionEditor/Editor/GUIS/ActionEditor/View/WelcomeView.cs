...
namespace PKC.ActionEditor
{
    ...
    {
        private Rect _lastCenteredButtonRect;
        ...
        public override void OnDraw()
        {
            ...
            {
                PreferencesWindow.Show(_lastCenteredButtonRect);
            }
        ...
        private bool DrawCenteredButton(string buttonText)
        {
            ...
            {
                GUILayout.FlexibleSpace();
                var clicked = GUILayout.Button(buttonText, GUILayout.Width(220), GUILayout.Height(40));
                _lastCenteredButtonRect = GUILayoutUtility.GetLastRect();
                if (clicked)
                {
                    ret = true;
                }
